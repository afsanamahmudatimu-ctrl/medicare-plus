  ...
  useEffect(() => {
    async function loadAppointmentData() {
      try {
        ...
        // Format doctors to ensure 'id' field exists
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <select value={appointmentType} onChange={(e) => setAppointmentType(e.target.value)}
                    className="w-full bg-slate-100 rounded-xl p-2.5 mt-1.5 text-sm outline-none">
                ...
                <button onClick={handleConfirmBooking} disabled={booking || !selectedDoctor || !selectedTime}
                  className="w-full bg-teal-600 text-white rounded-xl py-3 flex justify-center gap-2 text-sm disabled:opacity-60 hover:bg-teal-700">
